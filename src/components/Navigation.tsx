...
function Navigation() {
  ...
  const ulWrapperClassName = `absolute top-0 -right-[100vw] flex flex-col justify-center items-center bg-stone-200/50 w-screen h-screen lg:size-auto p-4 rounded-xs ${!isMenuClosed && '-translate-x-[100vw]'} lg:top-8 lg:right-1/2 lg:translate-x-1/2 transition-transform duration-500`
  const ulClassName = `flex flex-col lg:flex-row justify-center items-center w-[80%] h-[50%] sm:w-[60%] sm:h-[60%] lg:size-auto p-4 lg:p-0 gap-4 lg:gap-0 bg-stone-50 dark:bg-zinc-900 rounded-xs`;
