...
const SvgBootstrapLogo = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="url(#bootstrap-logo_svg__a)"
    ...
    />
    <path
      fill="url(#bootstrap-logo_svg__b)"
      stroke="#fff"
      ...
      filter="url(#bootstrap-logo_svg__c)"
    />
  </svg>
);
export default SvgBootstrapLogo;
