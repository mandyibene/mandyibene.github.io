...
const SvgPhpLogo = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      <clipPath id="php-logo_svg__c" clipPathUnits="userSpaceOnUse">
        <path d="M0 324h576V0H0z" />
      </clipPath>
      <clipPath id="php-logo_svg__d" clipPathUnits="userSpaceOnUse">
        <path d="M0 324h576V0H0z" />
      </clipPath>
      <radialGradient
        id="php-logo_svg__b"
    ...
    >
      <path
        ...
        style={{
          fill: "url(#php-logo_svg__b)",
          stroke: "none",
        }}
      />
    </g>
    <g
      clipPath="url(#php-logo_svg__c)"
      transform="matrix(1.25 0 0 -1.25 -4.4 394.299)"
    >
      <path
